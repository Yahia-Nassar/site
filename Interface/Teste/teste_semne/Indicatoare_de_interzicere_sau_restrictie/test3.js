...
var questions = [
    new Question("1.Care dintre urmatoarele indica intoarcerea interzisa?",
        ...
        ["A", "B","C"],
        "A"),
    new Question("2.Precizați ce semnificatie are urmatorul indicator :<br> <div  class='image_q'> <img alt='image' src='30.jpg' > </div> </br>",
        ["A: Claxonarea complet interzisa",
            "B: Claxonarea interzisa intre 6:00-22:00, cu exceptii",
            "C: Claxonarea permisa"],
        ["A", "B","C"],
        "A"),
    new Question("3.Ce semnifică indicatorul din imagine? <br> <div  class='image_q'> <img alt='image' src='36.png' > </div> </br>",
    ...
    ["<span> <div class='image'> <img  alt='image' src='39.jpg' >  A  </div> <div class='image'><img  alt='image' src='37.jpg' >  B  </div> <div class='image'><img  alt='image' src='40.jpg' >  C  </div> </span>",
        ...
        ["A", "B","C"],
        "C"),
    new Question("5.Ce semnificație are indicatorul din imagine?<br> <div  class='image_q'> <img alt='image' src='47.png' > </div> </br>",
