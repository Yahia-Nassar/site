...
function showScores() {
    ...
    gameOverHTML += "<input type='text' id='testNo' name='testNo' value='t2'>";
...
var questions = [
    new Question("1.Care dintre urmatoarele indica sfarsit de autostrada?",
        ...
        ["A", "B","C"],
        "B"),
    new Question("2.Precizați ce semnificatie are urmatorul indicator : <br> <div  class='image_q'> <img alt='image' src='73.png' > </div> </br>",
        ["A: Monitorizare trafic",
            "B: Control radar",
            "C: Service auto"],
        ["A", "B","C"],
        "A"),
    new Question("3.Ce semnifică indicatorul din imagine? <br> <div  class='image_q'> <img alt='image' src='27.png' > </div> </br>",
        ["A: Teren de camping",
            "B: Loc de popas",
    ...
    new Question("4.Care dintre urmatoarele semnifica drum pentru autovehicule?",
        ...
        ["A", "B","C"],
        "B"),
    new Question("5.Ce semnificație are indicatorul din imagine? <br> <div  class='image_q'> <img alt='image' src='38.png' > </div> </br>",
         ["A: Zona residentiala",
