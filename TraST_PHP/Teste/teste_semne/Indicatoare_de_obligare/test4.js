...
function showScores() {
    ...
    gameOverHTML += "<input type='text' id='testNo' name='testNo' value='t4'>";
...
var questions = [
    new Question("1.Care dintre urmatoarele anunta un drum pentru pietoni?",
        ...
        ["A", "B","C"],
        "A"),
    new Question("2.Precizați ce semnificatie are urmatorul indicator :<br> <div  class='image_q'> <img alt='image' src='13.png' > </div> </br>",
        ["A: Pista comuna pentru pietoni si biciclisti",
            "B: Delimitarea pistelor pentru pietoni si biciclisti",
            "C: Pista pentru biciclete"],
        ["A", "B","C"],
        "A"),
    new Question("3.Ce semnifică indicatorul din imagine? <br> <div  class='image_q'> <img alt='image' src='7.png' > </div> </br>",
        ["A: Ocolire",
