...
<h2 class="text-center">Indicatoare instalate la trecerea cu calea ferata</h2>
<div class="categorie">
<input type="image" src="../Indicatoare_instalate_la_trecerea_cu_calea_ferata/1.PNG" alt="Indicatoare instalate la trecerea cu calea ferata.html" class="center" >
<input type="image" src="../Indicatoare_instalate_la_trecerea_cu_calea_ferata/2.PNG" alt="Indicatoare instalate la trecerea cu calea ferata.html" class="center" >
<input type="image" src="../Indicatoare_instalate_la_trecerea_cu_calea_ferata/3.PNG" alt="Indicatoare instalate la trecerea cu calea ferata.html" class="center" >
</div>


<footer>
    <form action="../../../Auth/recordProgressCategories.php" method="post">
        <input type="text" id="sectiune" name="categorie" value="Indicatoare instalate la trecerea cu calea ferata">
