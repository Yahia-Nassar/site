...
<input type="image" src="../Indicatoare_kilometrice/3.PNG" alt="Indicatoare kilometrice.html" class="center" >
<input type="image" src="../Indicatoare_kilometrice/4.PNG" alt="Indicatoare kilometrice.html" class="center" >
<input type="image" src="../Indicatoare_kilometrice/5.PNG" alt="Indicatoare kilometrice.html" class="center" >
</div>
