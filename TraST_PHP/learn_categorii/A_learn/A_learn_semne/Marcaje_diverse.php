...
<h2 class="text-center">Marcaje diverse</h2>
<div class="categorie">
<input type="image" src="../Marcaje_diverse/1.PNG" alt="Marcaje_diverse.html" class="center" >
<input type="image" src="../Marcaje_diverse/2.PNG" alt="Marcaje_diverse.html" class="center" >
<input type="image" src="../Marcaje_diverse/3.PNG" alt="Marcaje_diverse.html" class="center" >
<input type="image" src="../Marcaje_diverse/4.PNG" alt="Marcaje_diverse.html" class="center" >
<input type="image" src="../Marcaje_diverse/5.PNG" alt="Marcaje_diverse.html" class="center" >
<input type="image" src="../Marcaje_diverse/6.PNG" alt="Marcaje_diverse.html" class="center" >
<input type="image" src="../Marcaje_diverse/7.PNG" alt="Marcaje_diverse.html" class="center" >
<input type="image" src="../Marcaje_diverse/8.PNG" alt="Marcaje_diverse.html" class="center" >
