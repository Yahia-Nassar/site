...
<h2 class="text-center">Marcaje laterale</h2>
<div class="categorie">
<input type="image" src="../Marcaje_laterale/1.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/2.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/3.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/4.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/5.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/6.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/7.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/8.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/9.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/10.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/11.PNG" alt="Marcaje_laterale.html" class="center" >
<input type="image" src="../Marcaje_laterale/12.PNG" alt="Marcaje_laterale.html" class="center" >

</div>
<footer>
    <form action="../../../Auth/recordProgressCategories.php" method="post">
        <input type="text" id="sectiune" name="categorie" value="Marcaje laterale">
