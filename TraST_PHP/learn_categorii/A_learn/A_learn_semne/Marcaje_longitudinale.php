...
<h2 class="text-center">Marcaje longitudinale</h2>
<div class="categorie">
<input type="image" src="../Marcaje_longitudinale/1.PNG" alt="Marcaje_longitudinale.html" class="center" >
<input type="image" src="../Marcaje_longitudinale/2.PNG" alt="Marcaje_longitudinale.html" class="center" >
<input type="image" src="../Marcaje_longitudinale/3.PNG" alt="Marcaje_longitudinale.html" class="center" >
<input type="image" src="../Marcaje_longitudinale/4.PNG" alt="Marcaje_longitudinale.html" class="center" >
<input type="image" src="../Marcaje_longitudinale/5.PNG" alt="Marcaje_longitudinale.html" class="center" >
<input type="image" src="../Marcaje_longitudinale/6.PNG" alt="Marcaje_longitudinale.html" class="center" >
<input type="image" src="../Marcaje_longitudinale/7.PNG" alt="Marcaje_longitudinale.html" class="center" >
