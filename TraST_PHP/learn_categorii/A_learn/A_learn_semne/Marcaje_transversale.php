...
<h2 class="text-center">Marcaje transversale</h2>
<div class="categorie">
<input type="image" src="../Marcaje_transversale/1.PNG" alt="Marcaje_transversale.html" class="center" >
<input type="image" src="../Marcaje_transversale/2.PNG" alt="Marcaje_transversale.html" class="center" >
<input type="image" src="../Marcaje_transversale/3.PNG" alt="Marcaje_transversale.html" class="center" >
