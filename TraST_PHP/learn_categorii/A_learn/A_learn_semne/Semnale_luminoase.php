...
<h2 class="text-center">Semnale luminoase</h2>
<div class="categorie">
<input type="image" src="../Semnale_luminoase/1.PNG" alt="Semnale_luminoase.html" class="center" >
<input type="image" src="../Semnale_luminoase/2.PNG" alt="Semnale_luminoase.html" class="center" >
<input type="image" src="../Semnale_luminoase/3.PNG" alt="Semnale_luminoase.html" class="center" >
<input type="image" src="../Semnale_luminoase/4.PNG" alt="Semnale_luminoase.html" class="center" >
<input type="image" src="../Semnale_luminoase/5.PNG" alt="Semnale_luminoase.html" class="center" >
<input type="image" src="../Semnale_luminoase/6.PNG" alt="Semnale_luminoase.html" class="center" >
<input type="image" src="../Semnale_luminoase/7.PNG" alt="Semnale_luminoase.html" class="center" >
<input type="image" src="../Semnale_luminoase/8.PNG" alt="Semnale_luminoase.html" class="center" >
<input type="image" src="../Semnale_luminoase/9.PNG" alt="Semnale_luminoase.html" class="center" >
<input type="image" src="../Semnale_luminoase/10.PNG" alt="Semnale_luminoase.html" class="center" >
<input type="image" src="../Semnale_luminoase/11.PNG" alt="Semnale_luminoase.html" class="center" >
