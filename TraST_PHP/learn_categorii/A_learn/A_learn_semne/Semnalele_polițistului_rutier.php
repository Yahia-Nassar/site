...
<h2 class="text-center">Semnalele polițistului rutier</h2>
<div class="categorie">

<input type="image" src="../Semnalele_polițistului_rutier/1.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
<input type="image" src="../Semnalele_polițistului_rutier/2.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
<input type="image" src="../Semnalele_polițistului_rutier/3.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
<input type="image" src="../Semnalele_polițistului_rutier/4.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
<input type="image" src="../Semnalele_polițistului_rutier/5.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
<input type="image" src="../Semnalele_polițistului_rutier/6.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
<input type="image" src="../Semnalele_polițistului_rutier/7.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
<input type="image" src="../Semnalele_polițistului_rutier/8.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
<input type="image" src="../Semnalele_polițistului_rutier/9.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
<input type="image" src="../Semnalele_polițistului_rutier/10.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
<input type="image" src="../Semnalele_polițistului_rutier/11.PNG" alt="Semnalele_polițistului_rutier.html" class="center" >
